        ...
        <div class="container">
            ...
            <div class="row mt-2">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="customer_name" value="{{ old('customer_name') }}" id="inputPassword" placeholder="customer Name" >
                      @error('customer_name')
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" name="phone" id="inputPassword" value="{{ old('phone') }}"  placeholder="Customer Phone" required>
                      @error('phone')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="mb-3 row mt-2">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control"  id="quantity" value="1" value="{{ old('quantity') }}" placeholder="Quantity">
                      @error('quantity')
                            <span class="text-danger">{{ $message }}</span>
                         @enderror
                    </div>
